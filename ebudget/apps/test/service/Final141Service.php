...
class Final141Service extends CServiceBase implements IFinal141Service {
    ...
    public function insert($budget, $file) {
        ...
        $budget = $json->decode(new \apps\common\entity\Final141(), $conv);
            ...
            if ($file != "undefined") {
                ...
                if (move_uploaded_file($file["tmp_name"], $target_file)) {
                    ...
                    if (!$this->datacontext->saveObject($update)) {
                        ...
                        $update2 = new \apps\common\entity\Final141();
    ...
    public function update($budget, $file, $fileUpload) {
        ...
        if ($fileUpload == "1") {
            ...
            $update = new \apps\common\entity\Final141();
            $update->id = $budget->id;
    ...
    public function delete($budgetId) {
        ...
        $repo = new \apps\common\entity\Final141();
        $repo->setId($budgetId);
        ...
        if (!$this->datacontext->removeObject($repo)) {
            ...
            $sql = "SELECT count(bg) as num FROM " . $this->ent . "\\Final141 as bg WHERE bg.budgetHeadId = " . $bgHeadId;
