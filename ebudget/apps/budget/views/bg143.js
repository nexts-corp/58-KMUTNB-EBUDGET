...
function bg143Form(param) {
    ...
    if (budgetPeriodArr != null && budgetTypeArr != null && planArr != null && projectArr != null && fundgroupArr != null && departmentArr != null) {
        $("#navBgDept").html("จัดทำคำของบประมาณแผ่นดิน ง.143");
    ...
    setTimeout(function () {
        ...
        if (typeof datas !== "undefined" && datas !== null) {
            ...
            $("button.approveFile").unbind("click").click(function () {
                ...
                $("#attLink").html('<a href="' + js_context_path + "/uploads/ebudget/" + list143Arr[id]["path"] + '"><i class="fa fa-file-zip-o"></i> ดาวโหลดเอกสารที่แนบไว้</a>');
                $("#descAttachment").html(list143Arr[id]["desc"]);
            });
        }
    }, 100);
}
    ...
    setTimeout(function () {
        ...
        if (typeof datas !== "undefined" && datas !== null) {
            ...
            if (data["result"] == true) {
                ...
                list143Arr[data["id"]]["budgetHeadId"] = data["budgetHeadId"];
