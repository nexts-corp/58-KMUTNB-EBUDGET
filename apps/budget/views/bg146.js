function bg146Form(){
    var html = '<div class="col-md-12 text-center">'
        + '<h4>'
            + 'แบบรายละเอียดคำของบประมาณเงินอุดหนุน (ง.146)'
        + '</h4>'
    + '</div>'
                    ...
                    + '<div id="collapse1One" class="accordion-body collapse in">'
                        + '<div class="panel-body">'
                            + '<form>'
                                ...
                                + '<div class="form-group">'
                                    + '<div class="col-md-9">'
                                        + '<label class="col-md-4 control-label text-right" for="xxx">รายการ - ประเภทเงินอุดหนุน</label>'
                                        + '<div class="col-md-8">'
                                ...
                                + '<div class="form-group">'
                                    + '<div class="col-md-9">'
                                        + '<label class="col-md-4 control-label text-right" for="xxx">คำของบประมาณปีงบประมาณที่ขอตั้งงบประมาณ</label>'
                                        + '<div class="col-md-8">'
                                            + '<input type="text" id="" name="" class="form-control input-sm" required>'
                                        + '</div>'
                                    + '</div>'
        ...
        + '<table id="table" class="table table-bordered table-striped table-condensed mb-none">'
            + '<thead>'
                + '<tr>'
                    ...
                    + '<th class="text-center">งบประมาณที่ได้รับการจัดสรรปีงบประมาณปัจจุบัน (2558)</th>'
                    + '<th class="text-center">คำของบประมาณปีงบประมาณที่ขอตั้งงบประมาณ (2559)</th>'
