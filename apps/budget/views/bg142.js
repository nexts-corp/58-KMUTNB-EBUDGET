function bg142Form(){
    var html = '<div class="col-md-12 text-center">'
        + '<h4>'
            + 'แบบรายละเอียดคำของบประมาณค่าจ้างชั่วคราว (ง.142)'
        + '</h4>'
    + '</div>'
    ...
    + '<div id="bidderTable" class="col-md-12">'
        + '<table id="table" class="table table-bordered table-striped table-condensed mb-none">'
            + '<thead>'
                + '<tr>'
                    + '<th class="text-center" rowspan="2" style="vertical-align: middle;">ลำดับที่</th>'
                    + '<th class="text-center" rowspan="2" style="vertical-align: middle;">ประเภท-ตำแหน่ง</th>'
                    + '<th class="text-center" colspan="3">อัตราเดิม (ตามการจัดสรรปี 2558)</th>'
                    + '<th class="text-center" colspan="3">คำขอปีงบประมาณ (2559)</th>'
                    + '<th class="text-center" rowspan="2" style="vertical-align: middle;">คำชี้แจง</th>'
                + '</tr>'
                + '<tr>'
                    + '<th class="text-center">อัตราค่าจ้าง</th>'
                    + '<th class="text-center">จำนวนอัตรา</th>'
