        ...
        $.post("fetchPlan", {year: $("#selectYear").val(),budget:$("#selectBudget").val()}, function (data) {
            ...
            if(data.listsPlan.length!==0){
                ...
                for (var i=0;i<data.listsPlan.length;i++) {
                    ...
                    html += '   <td>'+data.listsPlan[i].planName;
//                    html += '       <div class="row">';
//                    html += '           <div class="col-md-12">'+data.listsPlan[i].planName+'</div>';
//                    html += '       </div><br>';
//                    html += '       <div class="row">';
//                    html += '           <div class="col-md-2">';
//                    html += '               <select class="form-control"><option value="1">ผลผลิต</option><option value="2">โครงการ</option></select>';
//                    html += '           </div>';
//                    html += '           <div class="col-md-6">';
//                    html += '               <div class="form-group">';
//                    html += '                   <input type="text" class="form-control" ref-id="txtPlanAdd" placeholder="แผนงาน/โครงการ">';
//                    html += '               </div>';
//                    html += '           </div>';
//                    html += '       </div>';
                    html += '   </td>';
